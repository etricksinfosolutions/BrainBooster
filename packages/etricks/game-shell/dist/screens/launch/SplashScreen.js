...
export function SplashScreen() {
    ...
    return (_jsxs(LaunchStage, { ariaLabel: `${branding.displayName} — tap to continue`, onActivate: a11y.reducedMotion ? undefined : go, reducedMotion: a11y.reducedMotion, children: [_jsx(BrandArt, { art: art, fallbackLabel: branding.displayName, size: 220, reducedMotion: a11y.reducedMotion, bob: true }), _jsx("h1", { style: {
                    margin: 0,
                    fontSize: "clamp(1.8rem, 6vw, 2.8rem)",
                    fontWeight: 800,
                    color: "var(--ink)",
                    letterSpacing: "-0.01em",
                }, children: branding.displayName }), branding.tagline ? (_jsx("p", { style: { margin: 0, fontSize: "clamp(1rem, 3.4vw, 1.2rem)", color: "var(--dim)" }, children: branding.tagline })) : null, _jsx(MascotBadge, { mascot: branding.mascot, size: 96, reducedMotion: a11y.reducedMotion }), a11y.reducedMotion ? (_jsx("button", { type: "button", onClick: go, style: launchButtonStyle("primary", a11y), "aria-label": `Continue to ${branding.displayName}`, children: "Continue" })) : (_jsx("p", { "aria-hidden": "true", style: {
                    margin: 0,
                    fontSize: "0.9rem",
                    color: "var(--dim)",
