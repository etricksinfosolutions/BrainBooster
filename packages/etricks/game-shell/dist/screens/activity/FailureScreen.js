...
export function FailureScreen() {
    ...
    return (_jsxs("div", { style: {
            ...
            boxSizing: "border-box",
                ...
                }, children: "\uD83D\uDCAA" }), a11y.reducedMotion ? null : (_jsx("style", { children: "@keyframes gs-fail-pulse{0%,100%{transform:scale(1)}50%{transform:scale(1.12)}}" })), _jsx("h1", { style: { margin: 0, fontSize: "1.8rem", fontWeight: 800 }, children: "So close!" }), _jsx("p", { style: { margin: 0, color: "var(--dim)", maxWidth: 420 }, children: branding.mascot
                    ? `${branding.mascot.name} believes in you — give it another go!`
                    : "Every try makes you stronger. Give it another go!" }), score != null ? (_jsxs("p", { style: { margin: 0, fontSize: "1.05rem" }, children: ["Score ", _jsx("strong", { children: score })] })) : null, _jsxs("div", { style: {
                    display: "flex",
                    flexDirection: "column",
                    alignItems: "center",
                    gap: 12,
                    width: "100%",
                    marginTop: 8,
                }, children: [_jsx("button", { type: "button", style: button("primary"), onClick: () => navigate("activity"), children: "Try again" }), _jsx("button", { type: "button", style: button("ghost"), onClick: () => navigate("home"), children: "Home" })] })] }));
}
//# sourceMappingURL=FailureScreen.js.map