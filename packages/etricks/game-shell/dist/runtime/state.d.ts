...
export declare const DEFAULT_SETTINGS: SettingsSlice;
export declare const DEFAULT_ACCESSIBILITY: AccessibilitySlice;
/**
 ...
 */
export declare function initialState(identity: GameIdentity): RootState;
