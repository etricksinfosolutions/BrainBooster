 ...
 */
export declare const SCREENS: readonly ["splash", "loading", "onboarding", "login", "home", "profile", "avatar", "world-select", "level-select", "activity", "result", "victory", "failure", "pause", "reward", "daily-rewards", "weekly-rewards", "achievements", "challenges", "leaderboard", "shop", "premium", "parents", "settings", "accessibility"];
export type Screen = (typeof SCREENS)[number];
export declare const Screen: z.ZodEnum<["splash", "loading", "onboarding", "login", "home", "profile", "avatar", "world-select", "level-select", "activity", "result", "victory", "failure", "pause", "reward", "daily-rewards", "weekly-rewards", "achievements", "challenges", "leaderboard", "shop", "premium", "parents", "settings", "accessibility"]>;
/** Screens that make up the mandatory launch flow — none may be skipped straight to `activity`. */
export declare const LAUNCH_FLOW: readonly Screen[];
/** The default screen a game boots into after the launch flow completes. */
export declare const HOME_SCREEN: Screen;
