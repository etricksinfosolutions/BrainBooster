 ...
 */
export declare const ACTIVITY_TYPES: readonly ["multiple-choice", "true-false", "fill-blank", "word-search", "memory-match", "sequence-ordering", "drag-drop-match", "flash-cards", "image-quiz", "audio-quiz", "typing-challenge", "sorting", "classification", "hotspot", "puzzle-grid"];
