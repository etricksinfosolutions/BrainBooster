...
import { registerContentFactory } from "./factory.js";
import { quizQuestionFactory } from "./quiz-factory.js";
import { memoryPairFactory } from "./memory-factory.js";
import { activityFactoryFor } from "./activity-factory.js";

// Register built-in factories on import.
registerContentFactory(quizQuestionFactory);
registerContentFactory(memoryPairFactory);
// The Universal Activity Engine: one factory per activity type (ADR-0024).
for (const type of ACTIVITY_TYPES) registerContentFactory(activityFactoryFor(type));
